...
if menu == "Chat Assistant":
    ...
    Distress tolerance skills help you survive crisis situations without making things worse. These skills are from **DBT (Dialectical Behavior Therapy)**.
    
    ### Llama API Providers
    
    This app uses Llama models via:
    - **Groq Cloud**: Fastest inference, free tier available at groq.com
    - **Together.ai**: Free credits available at together.ai
    
    ### Crisis Resources
    
    If you're in immediate crisis:
    - **988** - Suicide and Crisis Lifeline (US)
    - **111** - NHS Mental Health Triage (UK)
